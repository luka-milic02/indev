...
(function(J, ne) {
    ...
    function nt(n, ...e) {
        ...
        const t = e.shift();
        if (N(n) && N(t))
            for (const o in t) N(t[o]) ? (n[o] || Object.assign(n, {
                [o]: {}
            }), nt(n[o], t[o])) : Object.assign(n, {
                [o]: t[o]
            });
        return nt(n, ...e)
    }
    ...
    function Ro(n, e, t) {
        ...
        return M(o) ? o(n, t) : Q(o) ? {
            [o]: n
        } : (o !== void 0 && T("Conversion «import» property must be a string or function. String means key of tool data to import. Function accepts a imported string and return composed tool data."), {})
    }
    ...
    class R extends we {
        ...
        set selected(e) {
            ...
            (t || o) && ((i = this.editorEventBus) == null || i.emit(Mo, {
                state: e
            }), t ? b.addFakeCursor() : b.removeFakeCursor(this.holder), (s = this.editorEventBus) == null || s.emit(Ao, {
                state: e
            }))
        }
        get selected() {
            ...
            return function(t) {
                ...
                return i.m = t, i.c = o, i.d = function(s, r, a) {
                    ...
                    if (i.r(a), Object.defineProperty(a, "default", {
                        ...
                        for (var l in s) i.d(a, l, (function(c) {
                            return s[c]
                        }).bind(null, l));
                    return a
                }, i.n = function(s) {
...
`)
                ...
                function v(k, m) {
                    for (var w = [], x = {}, I = 0; I < k.length; I++) {
                        ...
                        x[D] ? x[D].parts.push(B) : w.push(x[D] = {
                            id: D,
                            parts: [B]
                        })
                    }
...
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(vo)))) + " */");
                        ...
                        var Oe = K.css,
                            pe = K.media;
                        if (pe && B.setAttribute("media", pe), B.styleSheet) B.styleSheet.cssText = Oe;
                        else {
...
`)
    ...
    class ts {
        constructor(e) {
            this.nodes = {
                ...
                title: d.make("div", Te.title, {
                    textContent: e.title
                })
            }, this.nodes.root.appendChild(this.nodes.title), e.description !== void 0 && (this.nodes.description = d.make("div", Te.description, {
    ...
    const Yo = ie("ce-popover-item-html"),
        Ko = {
            root: Yo(),
            hidden: Yo(null, "hidden")
        };
    class Se extends pt {
        constructor(e, t) {
            var o, i;
            super(e), this.nodes = {
                root: d.make("div", Ko.root)
                    ...
                    l.push({
                        ...
                        onActivate: async () => {
                            const {
                                ...
                                Caret: p,
                                Toolbar: g
                            } = this.Editor, f = await h.convert(e, c.name, u.data);
    ...
    const wt = class Un extends we {
        constructor({
            ...
            super(), this.opened = !1, this.listeners = new Ee, this.popover = null, this.handleMobileLayoutToggle = () => {
                ...
                toolbox: d.make("div", Un.CSS.toolbox)
        ...
        async insertNewBlock(e, t) {
            ...
            a.call(te.APPEND_CALLBACK), this.api.caret.setToBlock(s), this.emit("toolbox-block-added", {
                block: a
    ...
    class vs extends E {
        ...
        async make() {
            ...
            const e = d.make("div");
            e.appendChild(document.createTextNode(H.ui(W.ui.toolbar.toolbox, "Add"))), e.appendChild(d.make("div", this.CSS.plusButtonShortcut, {
                textContent: "/"
            })), Re(this.nodes.plusButton, e, {
                hidingDelay: 400
            }), this.nodes.settingsToggler = d.make("span", this.CSS.settingsToggler, {
                innerHTML: Vi
            }), d.append(this.nodes.actions, this.nodes.settingsToggler);
            const t = d.make("div"),
                o = d.text(H.ui(W.ui.blockTunes.toggler, "Click to tune")),
                i = await bs("Slash", "/");
            t.appendChild(o), t.appendChild(d.make("div", this.CSS.plusButtonShortcut, {
                textContent: it(`CMD + ${i}`)
            })), Re(this.nodes.settingsToggler, t, {
                hidingDelay: 400
        ...
        makeToolbox() {
            ...
            }), this.toolboxInstance.on(Fe.BlockAdded, ({
                block: e
            }) => {
                const {
                    BlockManager: t,
    ...
    class ks extends E {
        constructor({
            ...
            }, this.opened = !1, this.popover = null, this.toolbarVerticalMargin = ge() ? 20 : 6, this.tools = new Map, window.requestIdleCallback(() => {
                this.make()
            }, {
                timeout: 2e3
            })
    ...
    })(Lt), Object.defineProperty(At, "__esModule", {
        value: !0
    }), At.canSetCaret = Is;
    var Ts = ue,
        Ss = Lt;
    ...
    function Dt(n, ...e) {
        ...
        const t = e.shift();
        if (Ye(n) && Ye(t))
            for (const o in t) Ye(t[o]) ? (n[o] === void 0 && Object.assign(n, {
                [o]: {}
            }), Dt(n[o], t[o])) : Object.assign(n, {
                [o]: t[o]
            });
        return Dt(n, ...e)
    }
    ...
    })(Ke), Object.defineProperty(jt, "__esModule", {
        value: !0
    ...
    var zt = {},
        Ut = {},
        hn = J && J.__spreadArray || function(n, e, t) {
            if (t || arguments.length === 2)
                for (var o = 0, i = e.length, s; o < i; o++)(s || !(o in e)) && (s || (s = Array.prototype.slice.call(e, 0, o)), s[o] = e[o]);
    ...
    })(Ve), Object.defineProperty(Wt, "__esModule", {
        value: !0
    ...
    function gn(n, e) {
        ...
        if (n.nodeType === Node.ELEMENT_NODE && n[t]) {
            var i = n[t];
            if ((0, lr.isSingleTag)(i) && !(0, rr.isNativeInput)(i) && !(0, ar.isLineBreakTag)(i))
                if (i[o]) i = i[o];
    ...
    var mn = {},
        Xt = {},
        qe = J && J.__spreadArray || function(n, e, t) {
            if (t || arguments.length === 2)
                for (var o = 0, i = e.length, s; o < i; o++)(s || !(o in e)) && (s || (s = Array.prototype.slice.call(e, 0, o)), s[o] = e[o]);
            return n.concat(s || Array.prototype.slice.call(e))
        };
    ...
    })(eo), Object.defineProperty(Gt, "__esModule", {
        value: !0
    }), Gt.isEmpty = Cr;
    var xr = Jt,
        Br = eo;
    ...
    function qr() {
        var n = (0, Vr.getRange)(),
            e = (0, Xr.make)("span");
        if (e.id = "cursor", e.hidden = !0, !!n) return n.insertNode(e),
            function() {
    ...
    class Zr extends E {
        ...
        arrowRightAndDown(e) {
            ...
            const {
                currentBlock: o
            } = this.Editor.BlockManager, s = ((o == null ? void 0 : o.currentInput) !== void 0 ? ze(o.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
        ...
        arrowLeftAndUp(e) {
            ...
            const {
                currentBlock: t
            } = this.Editor.BlockManager, i = ((t == null ? void 0 : t.currentInput) !== void 0 ? $e(t.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
    ...
    class Qr extends E {
        ...
        insert({
            ...
            return r && this.blockDidMutated(_n, this.getBlockByIndex(l), {
                index: l
            }), this._blocks.insert(l, c, r), this.blockDidMutated(Mn, c, {
                index: l
        ...
        async update(e, t, o) {
            ...
            return this._blocks.replace(r, s), this.blockDidMutated(An, s, {
                index: r
            }), s
        }
        replace(e, t, o) {
        ...
        insertDefaultBlockAtIndex(e, t = !1) {
            ...
            return this._blocks[e] = o, this.blockDidMutated(Mn, o, {
                index: e
        ...
        removeBlock(e, t = !0) {
            return new Promise(o => {
                ...
                e.destroy(), this._blocks.remove(i), this.blockDidMutated(_n, e, {
                    index: i
        ...
        bindBlockEvents(e) {
            ...
            this.readOnlyMutableListeners.on(e.holder, "keydown", o => {
                ...
                t.dragLeave(o)
            }), e.on("didMutated", o => this.blockDidMutated(An, o, {
        ...
        blockDidMutated(e, t, o) {
            ...
            return this.eventsDispatcher.emit(_o, {
                event: i
            }), t
        }
    }
...
`),
    ...
    class et extends E {
        ...
        navigatePrevious(e = !1) {
            ...
            const {
                previousInput: i,
                currentInput: s
            } = t, r = s !== void 0 ? $e(s) : void 0, a = e || r || !t.focusable;
    ...
    class ta extends E {
        ...
        toggleBlocksSelectedState(e, t) {
            const {
                BlockManager: o,
                BlockSelection: i
            } = this.Editor, s = o.blocks.indexOf(e), r = o.blocks.indexOf(t), a = e.selected !== t.selected;
    ...
    class Ie extends E {
        ...
        genHTML() {
            const {
                UI: e
            } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = d.make("div", Ie.CSS.overlay, {}), i = d.make("div", Ie.CSS.overlayContainer, {}), s = d.make("div", Ie.CSS.rect, {});
    ...
    class ma {
        ...
        get(e) {
            const {
                ...
                isInternal: o = !1,
                ...i
            } = this.config[e], s = this.getConstructor(t), r = t[Et.IsTune];
            return new s({
                name: e,
                constructable: t,
                config: i,
    ...
    class Hn extends E {
        ...
        prepareConfig() {
            const e = {};
            for (const t in this.config.tools) N(this.config.tools[t]) ? e[t] = this.config.tools[t] : e[t] = {
    ...
    class xa {
        ...
        set configuration(e) {
            ...
            N(e) ? this.config = {
                ...
                holder: e
            }, st(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = ko.VERBOSE), Vn(this.config.logLevel), st(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
            const t = {
