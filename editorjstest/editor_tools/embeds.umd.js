...
(function(c, u) {
    ...
    class m {
        ...
        render() {
            ...
            const {
                html: i
            } = m.services[this.data.service], r = document.createElement("div"), e = document.createElement("div"), o = document.createElement("template"), l = this.createPreloader();
        ...
        createPreloader() {
            const i = document.createElement("preloader"),
        ...
        onPaste(i) {
            ...
            const {
                ...
                height: a,
                id: s = b => b.shift() || ""
            } = m.services[r], h = (p = o.exec(e)) == null ? void 0 : p.slice(1), d = h ? l.replace(/<%= remote_id %>/g, s(h)) : "";
            this.data = {
                service: r,
                source: e,
                embed: d,
        ...
        embedIsReady(i) {
            ...
            return new Promise((o, l) => {
                e = new MutationObserver(g.debounce(o, 450)), e.observe(i, {
                    childList: !0,
                    subtree: !0
                })
            }).then(() => {
