        ...
        var w = function() {
            ...
            s = function() {
                var n = function(e) {
                        ...
                        var a = typeof e;
                        if (a !== "undefined")
                            if (a === "string") e !== "" && this._fromString(e);
                            else if (e instanceof n) {
                            var h = this;
                            e.forEach(function(u, f) {
                                h.append(f, u)
                            })
                        } else if (e !== null && a === "object")
                            if (Object.prototype.toString.call(e) === "[object Array]")
                                for (var t = 0; t < e.length; t++) {
                                    var y = e[t];
                                    if (Object.prototype.toString.call(y) === "[object Array]" || y.length !== 2) this.append(y[0], y[1]);
                                    else throw new TypeError("Expected [string, any] as entry at index " + t + " of URLSearchParams's input")
                                } else
        ...
        (function(d, v) {
            ...
            return function(d) {
                ...
                return c.m = d, c.c = v, c.d = function(i, s, p) {
                    c.o(i, s) || Object.defineProperty(i, s, {
                        enumerable: !0,
                        get: p
                    })
                }, c.r = function(i) {
                    ...
                    if (c.r(p), Object.defineProperty(p, "default", {
                        ...
                        for (var l in i) c.d(p, l, (function(n) {
                            return i[n]
                        }).bind(null, l));
                    return p
                }, c.n = function(i) {
                ...
                s.nextTick = function(f) {
                    ...
                    if (arguments.length > 1)
                        for (var b = 1; b < arguments.length; b++) m[b - 1] = arguments[b];
                ...
                var c = function(s) {
                    ...
                    i = function(s, p, l, n) {
                        return p = p || null, l = l || "&", n = n || null, s ? function(o) {
                            ...
                            var e, a, h = o;
                            if (n && (h = n + "[" + h + "]"), typeof s[o] == "object" && s[o] !== null) e = i(s[o], null, l, h);
                            else {
