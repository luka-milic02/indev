...
(function(i, s) {
    typeof exports == "object" && typeof module < "u" ? module.exports = s() : typeof define == "function" && define.amd ? define(s) : (i = typeof globalThis < "u" ? globalThis : i || self, i.InlineCode = s())
})(this, function() {
    "use strict";
    const i = "",
        s = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 8L5 12L9 16"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 8L19 12L15 16"/></svg>';
    class n {
        constructor({
            api: t
        }) {
        ...
        unwrap(t) {
            ...
            const o = e.getRangeAt(0),
                a = o.extractContents();
            (r = t.parentNode) == null || r.removeChild(t), o.insertNode(a), e.removeAllRanges(), e.addRange(o)
        }
        checkState() {
