...
(function(l, c) {
    typeof exports == "object" && typeof module < "u" ? module.exports = c() : typeof define == "function" && define.amd ? define(c) : (l = typeof globalThis < "u" ? globalThis : l || self, l.Checklist = c())
})(this, function() {
    "use strict";
    const l = "",
        c = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 12L10.4884 15.8372C10.5677 15.9245 10.705 15.9245 10.7844 15.8372L17 9"/></svg>',
    ...
    class C {
        ...
        createChecklistItem(e = {}) {
            ...
            return e.checked && t.classList.add(this.CSS.itemChecked), n.innerHTML = c, i.appendChild(n), t.appendChild(i), t.appendChild(a), t
        }
        enterPressed(e) {
            e.preventDefault();
            const t = this.items,
