...
(function(P, _) {
    ...
    const P = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 12L10.4884 15.8372C10.5677 15.9245 10.705 15.9245 10.7844 15.8372L17 9"/></svg>',
        ...
        mt = '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.2087 14.2H14.2" stroke="black" stroke-width="1.6" stroke-linecap="round"/><path d="M11.5 14.5C11.5 14.5 11 13.281 11 12.5M7 9.5C7 9.5 7.5 8.5 9 8.5C10.5 8.5 11 9.5 11 10.5L11 11.5M11 11.5L11 12.5M11 11.5C11 11.5 7 11 7 13C7 15.3031 11 15 11 12.5" stroke="black" stroke-width="1.6" stroke-linecap="round"/></svg>',
        ht = '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 14.2L8 7.4135C8 7.32872 7.90111 7.28241 7.83598 7.33668L5 9.7" stroke="black" stroke-width="1.6" stroke-linecap="round"/><path d="M14 13L16.4167 10.7778M16.4167 10.7778L14 8.5M16.4167 10.7778H11.6562" stroke="black" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>';
    ...
    function ie(e, ...t) {
        ...
        const n = t.shift();
        if (N(e) && N(n))
            for (const r in n) N(n[r]) ? (e[r] === void 0 && Object.assign(e, {
                [r]: {}
    ...
    })(A), Object.defineProperty(le, "__esModule", {
        value: !0
    ...
    var ue = {},
        ce = {},
        Ke = L && L.__spreadArray || function(e, t, n) {
    ...
    })(B), Object.defineProperty(de, "__esModule", {
        value: !0
    ...
    var Ye = {},
        me = {},
        W = L && L.__spreadArray || function(e, t, n) {
            if (n || arguments.length === 2)
                for (var r = 0, i = t.length, a; r < i; r++)(a || !(r in t)) && (a || (a = Array.prototype.slice.call(t, 0, r)), a[r] = t[r]);
            return e.concat(a || Array.prototype.slice.call(t))
        };
    ...
    function dn(e) {
        return Array.from(e.querySelectorAll((0, un.allInputsSelector)())).reduce(function(t, n) {
            return (0, cn.isNativeInput)(n) || (0, sn.containsOnlyInlineElements)(n) ? W(W([], t, !0), [n], !1) : W(W([], t, !0), (0, on.getDeepestBlockElements)(n), !0)
        }, [])
    }(function(e) {
        Object.defineProperty(e, "__esModule", {
            value: !0
    ...
    Object.defineProperty(D, "__esModule", {
        value: !0
    }), D.checkContenteditableSliceForEmptiness = An;
    var Mn = c,
        Nn = H;
    ...
    function Bn(e, t) {
        ...
        if (t === void 0 && (t = !0), (0, $n.isNativeInput)(e)) {
            ...
            var s = function(g, T) {
                    ...
                    T ? g.insertBefore(w, g.firstChild) : g.appendChild(w), a.setStart(w, 0), a.setEnd(w, 0)
                },
                o = function(g) {
                    return g != null
                },
            ...
            if (o(u)) {
                ...
                if (o(u) && u.nodeType === Node.TEXT_NODE) {
                    var m = (r = (n = u.textContent) === null || n === void 0 ? void 0 : n.length) !== null && r !== void 0 ? r : 0,
                        i = t ? 0 : m;
    ...
    function zn(e) {
        var t = (0, q.getDeepestNode)(e);
        if (t === null || (0, q.isEmpty)(e)) return !0;
        if ((0, q.isNativeInput)(t)) return t.selectionEnd === 0;
        if ((0, q.isEmpty)(e)) return !0;
    ...
    class $e {
        ...
        mergeItemWithPrevious(t) {
            ...
            if (n) {
                const m = y(n, !1);
                m.length !== 0 && m.length !== 0 ? a = m[m.length - 1] : a = n
            } else a = i;
            ...
            if (this.listStyle === "ordered") {
                ...
                z.forEach((a, l) => {
                    i.children.items.push({
                        ...
                        icon: ut.get(z.get(l)),
                        isActive: this.data.meta.counterType === z.get(l),
                        closeOnActivate: !0,
                        onActivate: () => {
                            this.changeCounters(z.get(l))
                        }
                    })
                }), t.push({
                    type: "separator"
